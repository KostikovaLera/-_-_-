        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            else if (comboBox3.SelectedIndex == 0)
            {
                ...
                for (int row = 0; row < STable.Rows.Count; row++)
                {
                    ...
                    else if (Convert.ToString(STable.Rows[row][1]) == "USD")
                    {
                        s2 = s2 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][1]) == "EUR")
                    {
                        s3 = s3 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][1]) == "UAH")
                    {
                        s4 = s4  + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][1]) == "KZT")
                    {
                        s5 = s5 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][1]) == "BYN")
                    {
                        s6 = s6 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][1]) == "GBR")
                    {
                        s7 = s7 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][1]) == "JPY")
                    {
                        s8 = s8 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][1]) == "CNY")
                    {
                        s9 = s9 + 1;
                    }
                }
            ...
            else if (comboBox3.SelectedIndex == 1)
            {
                ...
                for (int row = 0; row < STable.Rows.Count; row++)
                {
                    ...
                    else if (Convert.ToString(STable.Rows[row][2]) == "USD")
                    {
                        s2 = s2 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][2]) == "EUR")
                    {
                        s3 = s3 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][2]) == "UAH")
                    {
                        s4 = s4  + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][2]) == "KZT")
                    {
                        s5 = s5 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][2]) == "BYN")
                    {
                        s6 = s6 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][2]) == "GBR")
                    {
                        s7 = s7 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][2]) == "JPY")
                    {
                        s8 = s8 + 1;
                    }
                    else if (Convert.ToString(STable.Rows[row][2]) == "CNY")
                    {
                        s9 = s9 + 1;
                    }
                }
